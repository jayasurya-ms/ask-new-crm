...
export default function Carousel({
  ...
  return (
    <motion.div
      ...
      className="hidden lg:flex lg:col-span-3 flex-col justify-between p-8 bg-gradient-to-br from-primary/20 via-primary/60 to-transparent border-l border-white/10 relative overflow-hidden"
    >
      <motion.div
