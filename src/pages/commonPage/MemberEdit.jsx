...
const MemberEdit = () => {
  ...
  useEffect(() => {
    return () => {
      ...
      if (selectedFiledoc) URL.revokeObjectURL(selectedFiledoc);
    };
  ...
  const handleUpdate = async (e) => {
    ...
    // ✅ Validation
    if (!/^[0-9]{10}$/.test(formData.user_mobile_number || "")) {
      toast.error("Invalid mobile number");
      return;
    }

    if (
      formData.user_pan_no &&
      !/^[A-Z]{5}[0-9]{4}[A-Z]{1}$/.test(formData.user_pan_no)
    ) {
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
        <div>
          ...
          <p className="text-slate-500 font-medium">
            Complete administrative control over member information.
          </p>
        </div>
        <div className="flex gap-3 w-full md:w-auto">
          <Button
            onClick={() => navigate(-1)}
            variant="outline"
            className="flex-1 md:flex-none gap-2 rounded-xl border-slate-200 h-11 px-6"
          >
            <FiArrowLeft /> Back
          </Button>
          <Button
          ...
          <Card className="border-none shadow-md overflow-hidden bg-white sticky top-24">
            <CardContent className="p-2 space-y-1">
              ...
              <div className="px-4 pb-4">
                <Label className="block text-xs mb-2 text-slate-400">
                  ID Proof Document
                </Label>
                  ...
                  <div className="flex items-center gap-2 bg-slate-50 p-2 rounded-lg border border-dashed border-slate-200">
                    ...
                    <span className="text-[10px] text-slate-500 truncate flex-1">
                      {selectedFiledoc
                        ...
                        : formData.user_proof_doc || "No document"}
                    </span>
                    <Label
                      htmlFor="member_doc"
                      className="text-blue-700 hover:text-blue-800 cursor-pointer text-[10px] whitespace-nowrap"
                    >
                      Change
                    </Label>
                    <input
        ...
        <div className="lg:col-span-3 space-y-8">
          <Tabs defaultValue="personal" className="w-full">
            <TabsList className="bg-white border p-1 rounded-2xl w-full justify-start overflow-x-auto shadow-sm mb-6 h-14">
              <TabsTrigger
                value="personal"
                className="rounded-xl px-6 data-[state=active]:bg-primary/5 data-[state=active]:text-primary gap-2"
              >
                <FiUser /> Personal
              </TabsTrigger>
              <TabsTrigger
              ...
              <Card className="border-none shadow-md">
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      onValueChange={(v) =>
                        handleSelectChange("user_gender", v)
                      }
              ...
              <Card className="border-none shadow-md">
                <CardHeader className="border-b pb-4">
                  <CardTitle className="text-lg flex items-center gap-2">
                    <FiAnchor className="text-blue-600" /> Father's Details
                  </CardTitle>
                </CardHeader>
                <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-6">
                  <div className="space-y-2">
            ...
            >
              <Card className="border-none shadow-md">
                <CardHeader className="border-b pb-4">
                  <CardTitle className="text-lg flex items-center gap-2">
                    <FiHome className="text-primary" /> Residential Address
                  </CardTitle>
                </CardHeader>
              ...
              <Card className="border-none shadow-md">
                <CardHeader className="border-b pb-4">
                  <CardTitle className="text-lg flex items-center gap-2">
                    <FiBriefcase className="text-blue-600" /> Office Address
                  </CardTitle>
                </CardHeader>
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
                  <div className="space-y-2 md:col-span-2">
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        handleSelectChange("f_motherorga", v)
                      }
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Select" />
            ...
            >
              <Card className="border-none shadow-md">
                <CardHeader className="border-b pb-4">
                  <CardTitle className="text-lg flex items-center gap-2">
                    <FiAward className="text-primary" /> Membership & Community
                  </CardTitle>
                </CardHeader>
                <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-6">
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2 md:col-span-2">
                    <Label>Introducer Address</Label>
                    <Input
                      name="f_mintroadd"
                  ...
                  <div className="space-y-2">
                    <Label>Courier Preference</Label>
                    <Select
                      onValueChange={(v) =>
                  ...
                  <div className="space-y-2">
                    <Label>Membership ID (Admin Only)</Label>
                    <Input
                      name="user_mid"
